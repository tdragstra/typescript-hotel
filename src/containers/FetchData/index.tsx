...
const FetchData: FunctionComponent = () => {
	...
	const forecasts = useAppSelector<WeatherForecast[]>(
		(state) => state.weather.forecasts
	);
	const startDateIndex = useAppSelector<number>(
		(state) => state.weather.startDateIndex
	);
			...
			<div className="container">
				...
				<div className="box container-box">
					...
					<h5 className="subtitle is-5">
						This component demonstrates fetching data from the server and
